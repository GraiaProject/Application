...
class FileList(BaseModel):
    ...
    isFile: Optional[bool] = None # 是否为文件
...
class FileConfig(BaseModel):
    ...
    id: Optional[str] = None
    length: Optional[int] # 文件长度
    downloadTimes: Optional[int] # 下载次数
    uploaderId: Optional[int]  # 上传者QQ
    uploadTime: datetime  # 上传时间
    lastModifyTime: datetime  # 最后修改时间
    downloadUrl: Optional[str] = None # 文件下载链接
    sha1: Optional[str] = None # 文件sha1值
    md5: Optional[str] = None # 文件md5值
